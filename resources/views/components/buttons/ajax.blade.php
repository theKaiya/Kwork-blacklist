...
<div class="text-center" ng-if='!items.get().sign_in_to_continue && !items.spinner && !items.spinner_more && items.get().last_page > items.get().page' ng-cloak>
    <a ng-click="getContent(true)" href="" class="btn rounded btn-sm b-success text-success p-x-md m-y">Больше</a>
</div>